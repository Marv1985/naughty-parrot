...
// VARS
$hidden_header_seo = esc_html(get_field('hidden_header_seo'));
    ...
    <div class="homepage_intro_parent">
        ...
        <div class="intro_container">
            <div class="intro_title_and_image">
                <h1><?php echo $hidden_header_seo; ?></h1>
                <img class='mobile_image' class='header_image' src="<?php echo $mobile_image; ?>" alt="Mobile image">
                <img class='header_image' src="<?php echo $header_image; ?>" alt="Be Bold Dance Free">
